...
A: Add two units which are representations of two main diagonals to the unit list. Then use deep-first search and reduce-puzzle to solve the diagonal sudoku problem.
